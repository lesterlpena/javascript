...
function repeat(operation, num) {
  if (num > 0) {
      operation();
      repeat(operation, num - 1); // Note: If want to use decrement operator, need to use the --num
  }
}
